...
export class TcpIncreased extends ethereum.Event {
  get params(): TcpIncreased__Params {
    return new TcpIncreased__Params(this);
  }
}

export class TcpIncreased__Params {
  _event: TcpIncreased;

  constructor(event: TcpIncreased) {
    this._event = event;
  }
...
export class AdventureContract extends ethereum.SmartContract {
  ...
  latestPassOf(
    ...
    let result = super.call(
      "latestPassOf",
      "latestPassOf(uint256):((uint256,uint256,uint256,uint256,uint256,uint256,bool,bool,(uint256,uint256,uint256,uint256[])))",
  ...
  pass(passId_: BigInt): AdventureContract__passResultValue0Struct {
    let result = super.call(
      "pass",
      "pass(uint256):((uint256,uint256,uint256,uint256,uint256,uint256,bool,bool,(uint256,uint256,uint256,uint256[])))",
